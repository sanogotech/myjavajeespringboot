...
export default class RequerantComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('requerant-heading'));
...
export class RequerantDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('audiencierApp.requerant.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-requerant'));
}
