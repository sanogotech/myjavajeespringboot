...
export default class AvocatComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('avocat-heading'));
...
export class AvocatDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('audiencierApp.avocat.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-avocat'));
}
