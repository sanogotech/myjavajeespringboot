<template>
    <b-navbar toggleable="md" type="dark" class="bg-primary">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">audiencier</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/audience">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.audience')">Audience</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/requerant">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.requerant')">Requerant</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/juridiction">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.juridiction')">Juridiction</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/avocat">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.avocat')">Avocat</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/contentieux">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.contentieux')">Contentieux</span>
                    </b-dropdown-item>
